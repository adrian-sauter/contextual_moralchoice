...
parser.add_argument(
    ...
    type=str,
    help="Model to collect --- see models.py for an overview of supported models",
)
...
parser.add_argument(
    ...
    default=[1],
    type=int,
    help="Batch index to collect (multiple allowed)",
    nargs="+"
)
...
EXPERIMENT_NAME = "together_models"
...
RESULT_FILES = [
    f"data/scenarios/together_batches/results_{model_id}_batch{BATCH_INDEX}.jsonl" for BATCH_INDEX in BATCH_INDICES
]
